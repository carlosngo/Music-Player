...
public class InfoPanel extends JPanel {
    ...
    public InfoPanel(SongController controller, User user){
        ...
        sp.setScrollSize(controller.getMainController().getDashboard().getCategoryPanel().getWidth()-15, 150);
        //sp.setScrollSize(1300, 150);
    ...
    public InfoPanel(SongController controller, String keyword) {
        ...
        sp.setScrollSize(controller.getMainController().getDashboard().getCategoryPanel().getWidth()-18, 150);
        //sp.setScrollSize(1300, 150);
